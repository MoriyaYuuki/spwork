...
int main()
{
	...
	while (1) {
		...
		Notice_coordinates->x = 0;
		Notice_coordinates->y = 0;
		//色追跡
		if (startCheckMeanShift(original_frame)>0){
